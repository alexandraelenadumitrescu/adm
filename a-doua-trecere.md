...
## Legendă stare
- [solid] acoperit, multiple seturi, scor mare, testat pe probleme
- [partial] acoperit teoretic + grilă, dar **netestat pe calcul aplicat complet**
- [slab] slab / neînceput / sursă absentă
- [capcana] capcană recurentă — de flagat la fiecare recapitulare
...
- [ ] [partial] **Interval de încredere pentru medie** — o problemă completă cu cifre, cronometrată
- [ ] [partial] **Interval de încredere pentru proporție** — idem
- [ ] [partial] **Determinarea volumului eșantionului** — pentru medie ȘI pentru proporție, cu/fără revenire
- [ ] [partial] **Sondaj de serii cu η²** — calcul complet + verificarea relației η² < 1/N₀ (tip S4/S5 becuri)
- [ ] [partial] **Estimatori serii de talie diferită** (PPS/PPM, totaluri) — numai numiți în trecerea 1, fără calcul aplicat
- [ ] [partial] **Poststratificare cu calcul numeric** — concept + penalizare acoperite, dar fără exercițiu complet
- [ ] [partial] **Verificarea reprezentativității** — testele z / χ² / Kolmogorov-Smirnov aplicate pe date

### Capcane de re-flagat (au apărut ca greșeli în trecerea 1)
- [ ] [capcana] **Eroare = √(dispersie/n)** — radical jos. NU sări radicalul (greșit de mai multe ori)
- [ ] [capcana] **Volum = totul la pătrat** (z²·S²/Δ²), niciun radical — inversul erorii
- [ ] [capcana] **Δ = z · σ** — produs, NU sumă (greșit grila „z+σ")
- [ ] [capcana] **Dispersia proporției = p(1−p)**, niciodată p²
- [ ] [capcana] **Neyman = abaterea standard σ**, NU dispersia σ² (capcană din diagnostic + 2024)
- [ ] [capcana] **Fără revenire → ×√(1−n/N)**; la n<0,05N ≈ 1, se ignoră
...
- [ ] [solid] Consolidare prin grile directe (reading doar pe ce ratez)
- [ ] **Indici de grup** — [slab] punct slab istoric (0/3 examen real 2024). Laspeyres/Paasche,
...
- [ ] [partial] **Cald de la examen recent (~o săptămână)** — verificare cu UN set de grile,
...
- [ ] [slab] **Cea mai grea zonă a materiei.** ACF/PACF, identificare model, staționaritate
- [ ] [slab] Abordare prin rezumate + pattern din examene (Bourbonnais lipsește din bibliotecă)
...
- [ ] [solid] Solid (diagnostic 3/3). Consolidare prin grile.

### c–d (Bourbonnais [5] — SURSĂ ABSENTĂ): ipoteze model clasic + inferență
- [ ] [slab] Verificarea ipotezelor: homoscedasticitate, autocorelare (Durbin-Watson), normalitate
- [ ] [slab] Inferența pe coeficienți (testul t pe β, interval de încredere pentru β)
- [ ] [?] Dependent de sourcing Bourbonnais [5]

---

## CAP. 5 — DEMOGRAFIE  *(diagnostic 1/3 — slab, sursă [3] disponibilă integral)*
- [ ] [slab] Capitol slab, de la zero. Sursa Mihăescu [3] e disponibilă — randament maxim
- [ ] [capcana] **Natalitate vs fertilitate** (greșit la diagnostic) — natalitate/pop. totală; fertilitate/femei fertile
- [ ] [capcana] **Unitatea de observare la recensământ = persoana** (greșit la diagnostic)
...
- [ ] [solid] Solid pe recunoaștere. Nu atac în profunzime, doar tipul de problemă
- [ ] [capcana] **Analiza cluster**: omogen în interior, eterogen între grupuri
